...
class CodexAdapter(AdapterBase):
    def open_app(self) -> bool:
        self.log_action("open_app", {"target": "codex", "dry_run": self.dry_run})
        return True

    def close_app(self) -> bool:
        self.log_action("close_app", {"target": "codex", "dry_run": self.dry_run})
        return True
    ...
    def read_unread(self, limit: int = 10) -> List[Dict[str, Any]]:
        self.log_action("read_unread", {"target": "codex", "limit": limit, "dry_run": self.dry_run})
        return []
